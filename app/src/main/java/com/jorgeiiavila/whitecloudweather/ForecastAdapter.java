...
public class ForecastAdapter extends RecyclerView.Adapter<ForecastAdapter.ViewHolder> {
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public ViewHolder(View v) {
            super(v);
            mHourDay = v.findViewById(R.id.hour_in_recycler_view);
            mTemperature = v.findViewById(R.id.temperature_in_recycler_view);
            mConditionPic = v.findViewById(R.id.condition_pic_in_recycler_view);
            mLayout = v.findViewById(R.id.recycler_view_item_layout);
        }
